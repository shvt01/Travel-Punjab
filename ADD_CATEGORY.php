...
if (isset ($_POST["submit"])){
    ...
    if($result > 0){
        echo "<div class='col-12 alert alert-success role='alert' style='background-color:lightgreen; font-size:20px' ><i class='fa-solid fa-check' style='color:green;'></i>Category added!</div>";
    }else{ 
