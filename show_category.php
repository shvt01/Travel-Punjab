...
<div class="col-md-7 mx-auto py-4 ">
 ...
 foreach($query as $data){
    ...
    <tr>
         ...
         <td><a href="delete_category.php?id=<?php echo $data['id'];?>" class="text-danger"><i class="fa-solid fa-trash-can"></i></a></td>
         <td><a href="edit_category.php?id=<?php echo $data['id'];?>" class="text-danger"><i class="fa-solid fa-pen-to-square"></i>
